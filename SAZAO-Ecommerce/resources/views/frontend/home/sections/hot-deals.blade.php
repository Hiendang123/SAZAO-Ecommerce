                ...
                <div class="col-xl-6 col-lg-6">
                    @if ($homepage_secion_banner_three->banner_one->status == 1)
                        <div class="wsus__single_banner_content banner_1">
                            <a class="wsus__monthly_top_banner_img"
                                href="{{ $homepage_secion_banner_three->banner_one->banner_url }}">
                        ...
                        <div class="col-12">
                            @if ($homepage_secion_banner_three->banner_two->status == 1)
                                <div class="wsus__single_banner_content single_banner_2">
                                    <a class="wsus__monthly_top_banner_img"
                                        href="{{ $homepage_secion_banner_three->banner_two->banner_url }}">
                                        <img class="img-fluid w-100"
                        ...
                        <div class="col-12 mt-lg-4">
                            <div class="wsus__single_banner_content">
                                @if ($homepage_secion_banner_three->banner_three->status == 1)
                                    <a class="wsus__monthly_top_banner_img"
                                        href="{{ $homepage_secion_banner_three->banner_three->banner_url }}">
                                        <img class="img-fluid w-100"
